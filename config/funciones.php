...
/*
    ...
    function sanearLogin($nombre) {
        // Pasar a minúsculas
        $nombre = mb_strtolower($nombre, 'UTF-8');

        // Reemplazar acentos manualmente (pero respetar ñ y ü)
        $nombre = str_replace(
            ['á','é','í','ó','ú','à','è','ì','ò','ù','ä','ë','ï','ö','ÿ'],
            ['a','e','i','o','u','a','e','i','o','u','a','e','i','o','y'],
            $nombre
        );

        // Quitar todo lo que no sea letras (a-z, ñ, ü) o números
        $nombre = preg_replace('/[^a-z0-9ñü]/u', '', $nombre);
