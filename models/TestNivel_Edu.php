...
class TestNivel extends Conectar
{

    public function listarTestNivel()
    {
        $conectar = parent::conexion();
        parent::set_names();
        $sql = "SELECT * FROM `testnivel&tipoCurso`";
    ...
    public function update_tipocurso($idTipoCurso, $descrTipoCurso, $codTipo, $textTipo, $minAlumnTipo, $maxAlumTipo)
    {
        ...
        if(empty($resultado)){
            ...
            $sql = "UPDATE tm_tipocurso SET descrTipo='$descrTipoCurso', codTipo='$codTipo', textTipo='$textTipo', minAlumTipo=$minAlumnTipo, maxAlumTipo=$maxAlumTipo, fecModiTipoCurso=now() WHERE idTipo = '$idTipoCurso'";    
