...
switch ($_GET["op"]) {
    ...
    case "listarAsistencia":
        ...
        // Archivo LOG
        $nombreLog =  $_SESSION['usuPre_idInscripcion'] . " - " . $_SESSION['usu_nom'];
        ...
        foreach ($datos as $row) {
            ...
            $sub_array[] = '<a href="../MntPersonal_Edu/?buscar=' . $row["emailUsuario"] . '" class="">' . $row["nomPersonal"] . ' '. $row["apePersonal"] .'</a>';
    ...
    case "inicioAsistencia":
        $usuId = $_SESSION["usuPre_idInscripcion"];
