...
switch ($op) {
    case "mostrarElementos":
        $datos = $conocimiento->mostrarElementos();
        ...
        case "agregarElemento":
            ...
            $tipo = $_POST["tipo"];
            $conocimiento->agregarElemento($descripcion,$tipo);
            break;
        case "cargarElemento":
            $idElemento = $_POST["idElemento"];
            $datos = $conocimiento->cargarElemento($idElemento);
        ...
        case "editarElemento":
            ...
            $idElemento = $_POST["idElemento"];
            $tipo = $_POST["tipo"];
            $conocimiento->editarElemento($idElemento,$descripcion,$tipo);
            break;
        case "cambiarEstado":
            $idElemento = $_POST["idElemento"];
            $conocimiento->cambiarEstado($idElemento);
            break;
        case "listarTipos":

            $datos = $conocimiento->mostrarElementosActivos();
            echo json_encode($datos);
