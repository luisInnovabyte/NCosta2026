            ...
            <div class="modal-body">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <div class="row">
                            <h5 class="mb-4">Se muestran las facturas realizadas en esta llegada.</h5>
                        </div>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="table-responsive order-mobile-first">
                                        ...
                                        $nombreCampos = ["ID", "Nombre", "A Quien Factura", "Número Factura", "Fecha", "Nº Proforma", "Ver Factura", "Abonar", "Pagado", "Pago Pendiente"];
                                        $nombreCamposFooter = ["ID", "Nombre", "A Quien Factura", "Número Factura", "Fecha", "Nº Proforma", "Ver Factura", "Abonar", "Pagado", "Pago Pendiente"];
