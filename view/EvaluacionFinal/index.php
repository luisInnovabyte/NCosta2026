...
<head>
    ...
    ?>
        ...
        <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/datetime/1.5.5/css/dataTables.dateTime.min.css">
    ...
    background-color:rgba(81, 166, 250, 0.73);
        ...
        .table-responsive.order-mobile-first {
        background: #fff;
        padding: 20px 15px;
        border-radius: 12px;
        ...
        #evaluacionFinalAlumnos thead tr,
        #evaluacionFinalAlumnos tbody tr {
        border-bottom: 1px solid #ddd;
        }

        /* No bordes verticales en celdas */
        #evaluacionFinalAlumnos th,
        #evaluacionFinalAlumnos td {
        border: none;
        padding: 10px 12px;
        }

        /* Header destacado */
        #evaluacionFinalAlumnos thead th {
        ...
        #evaluacionFinalAlumnos tbody tr:nth-child(odd) {
        background-color: #f9f9f9;
        }

        /* Hover filas */
        #evaluacionFinalAlumnos tbody tr:hover {
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item" aria-current="page">Evaluación Final</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <div class="card">
                                    <div class="card-header bg-transparent">
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <h6 class="mb-0 fw-bold">Evaluación Final</h6>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <select class="select2 js-example-responsive" data-placeholder="SELECCIONE DEPARTAMENTO" style="width: 100%; height: 65px !important;" id="selectDepartamento">
                                                <?php foreach ($datosDepa as $row) { ?>
                                                    <option class="form-select wd-50" value="<?php echo $row["idDepartamentoEdu"] ?>"><?php echo $row["nombreDepartamento"] ?> </option>
                                                <?php } ?>
                                            </select>
                                        </div>               
                                        ...
                                        <div class="col-12" id="">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <tr>
                                                        <th colspan="4">
                                                            <div class="d-flex align-items-center gap-3 mt-2 mb-2">
                                                                <label for="fechaMinimaFiltro" class="mb-0">Fecha Desde:</label>
                                                                <input type="date" id="fechaMinimaFiltro" class="form-control flatpickr-input" style="width: 150px;">
                                                                <label for="fechaMaximaFiltro" class="mb-0">Fecha Hasta:</label>
                                                                <input type="date" id="fechaMaximaFiltro" class="form-control flatpickr-input" style="width: 150px;">
                                                                <button id="aplicarFiltroFecha" class="btn btn-sm btn btn-outline-success">ACTUALIZAR</button>
                                                                <button id="quitarFiltroFecha" class="btn btn-sm btn btn-outline-danger">TODOS</button>
                                                            </div>
                                                        </th>
                                                    </tr>
                                                    </tbody>
                                                ...
                                                <?php
                                                    $nombreTabla = "evaluacionFinalAlumnos";
                                                    $nombreCampos = ["ID", "Alumno",  "Llegada", "Código Grupo","Matriculas","Fecha Matrículas Inicio","Fecha Matrículas Fin","Fecha inicio","Fecha Fin", "Resultado", "Gestionar"];
                                                    $nombreCamposFooter = ["ID", "Alumno",  "Llegada", "Código Grupo","Matriculas","Fecha Matrículas Inicio","Fecha Matrículas Fin", "Fecha inicio","Fecha Fin", "Resultado", "Gestionar"];
