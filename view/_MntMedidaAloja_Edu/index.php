    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Medidas de Alojamiento</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    <h2 class="card-title">Medidas de Alojamiento</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-end mg-b-10">
                            <div class="tx-center col-12 col-lg-2 row">
                                <button class="btn btn-primary waves-effect col-12" data-bs-toggle="modal" data-bs-target="#insertar-medidaAloja-modal">Agregar Medida Alojamiento</button>
                                <br>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                    <?php
                                    $nombreTabla = "medidaAloja_table";
                                    $nombreCampos = ["ID", "Descripción", "Observaciones", "Estado", "Acción"];
                                    $nombreCamposFooter = [
                                        "ID",
                                        "<input type='text' class='form-control' id='FootDescripcion' name='FootDescripcion' placeholder='Buscar Descripción'>",
                                        "Observaciones", "Estado", "Acción"
                                    ];
