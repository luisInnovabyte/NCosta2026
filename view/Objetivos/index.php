...
<body>
    ...
    <main class="page-content">
        ...
        <input type="hidden" id="idiomaSelect" value="<?php echo $_GET['idioma']?>">
        <input type="hidden" id="tipoSelect" value="<?php echo $_GET['tipo']?>">
        <input type="hidden" id="nivelSelect" value="<?php echo $_GET['nivel']?>">
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="addRow" class="col-12 mg-sm-b-15 bd-3">

                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-end mg-b-10">
                                            <button class="btn btn-primary waves-effect col-12 col-lg-2" data-bs-toggle="modal" data-bs-target="#insertar-objetivos-modal">Agregar Sección</button>
                                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="table-responsive order-mobile-first">
                                        <?php
                                        $nombreTabla = "objetivo_table";
                                        $nombreCampos = ["idTitular","Sección Objetivo","Objetivos","Estado","Acciones"];
                                        $nombreCamposFooter = ["idTitular","Sección Objetivo","Objetivos","Estado","Acciones"];
