            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item" aria-current="page">Trabajadores</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <button class="btn btn-primary waves-effect col-12 col-lg-1" data-bs-toggle="modal" data-bs-target="#agregar-trabajador-modal">Agregar Trabajador</button>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                    <?php
                                    $nombreTabla = "trabajadores_table";
                                    $nombreCampos = ["ID", "Nombre","Profesiones", "Estado", "Acciones"];
                                    $nombreCamposFooter = ["ID", "Nombre","Profesiones", "Estado", "Acciones"];
