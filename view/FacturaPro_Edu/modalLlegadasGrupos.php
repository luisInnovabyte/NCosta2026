<div id="buscar-LlegadasGrupos-modal" class="modal fade">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <div class="row">
                            <h5 class="mb-4 ">Servicios asignados previamente en Llegadas para el grupo <b id="textoGrupo"></b></h5>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div id="matriculacionTableDiv" class="table-responsive order-mobile-first">
                                <?php
                                $nombreTabla = "matriculacionTableNewGrupos";
                                $nombreCampos = ["Tipo","Tarifa", "Descripción", "Observaciones", "Importe", "IVA", "Descuento", "Fecha Inicio", "Fecha Fin", "TipoId",'Nombre Alumno'];
                                $nombreCamposFooter = [
                                    "Tipo",
                                    "Tarifa",
                                    "Descripción",
                            ...
                            <div style="display: flex; gap: 20px; width: 100%;">  
                                ...
                                <div style="flex: 1; text-align: center;">
                                    <h3>Transfer Llegada</h3>
                                    <div id="transferLlegadaTableDiv" class="table-responsive order-mobile-first">
                                        <?php
                                        $nombreTabla = "transferLlegadaGrupo";
                                        $nombreCampos = ["CÓDIGO","CONCEPTO", "IVA", "TOTAL"];
                                        $nombreCamposFooter = ["CÓDIGO","CONCEPTO","IVA","TOTAL"];
                                ...
                                <!-- Contenedor 2 -->
                                <div style="flex: 1; text-align: center;">
                                    <h3>Transfer Regreso</h3>
                                    <div id="transferRegresoTableDiv" class="table-responsive order-mobile-first">
                                        <?php
                                        $nombreTabla = "transferRegresoGrupo";
                                        $nombreCampos = ["CÓDIGO","CONCEPTO","IVA","TOTAL"];
                                        $nombreCamposFooter = ["CÓDIGO","CONCEPTO","IVA","TOTAL"];
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" title="Almacena todas las tarifas" onClick="agregarTodosTarifaGrupo()">Insertar Todos</button>
            </div>
        </div>
    </div>
</div>