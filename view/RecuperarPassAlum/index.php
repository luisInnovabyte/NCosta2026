      ...
      <div class="row g-3 align-items-center">
        <div class="col-lg-6 d-flex">
          <div class="card-body p-5 w-100">
            ...
            <img src="../../public/img/logo_pequeno.png" class="mb-4" width="200" alt="">
            </div>
            <div id="emailInput">
            <h4 class="fw-bold">¿Contraseña olvidada?</h4>
            <p class="mb-0">Introduce tu nick de usuario para enviarte un mensaje de confirmación</p>

            <div class="form-body mt-4">
              <form class="row g-3">
                <div class="col-12">
                  <label class="form-label">Nickname</label>
                  <input type="hidden" id="email_recuperar">
                  <input type="text" class="form-control" id="nicknameRecu" maxlengt="60" placeholder="Nickname enviado al correo. Ej Jose392">
                </div>
                <div class="col-12">
