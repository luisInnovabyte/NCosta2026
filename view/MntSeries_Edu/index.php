            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Series</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <button class="btn btn-primary waves-effect col-12 col-lg-1" data-bs-toggle="modal" data-bs-target="#insertar-serie-modal">Agregar Series</button>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                    <?php
                    $nombreTabla = "series_table";
                    $nombreCampos = ["ID", "Descripcion", "Prefijo","Número Preforma","Número Factura","Número Abono", "Acción"];
                    $nombreCamposFooter = [
                        "ID",
                        "<input type='text' class='form-control' id='Descripcion' name='Descripcion' placeholder='Buscar Descripcion'>",
                        "<input type='text' class='form-control' id='Nombe' name='Nombe' placeholder='Buscar Prefijo'>","Número Preforma","Número Factura","Número Abono",
                        "Acción"
                    ];
