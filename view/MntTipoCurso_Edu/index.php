    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Tipos de Cursos</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            ...
            <div class="page-header-custom">
                <h2><i class='bx bx-category me-2'></i>Gestión de Tipos de Cursos</h2>
                <p>Administra las categorías y tipos de cursos disponibles</p>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end mb-3">
                            <button class="btn btn-add-record waves-effect" data-bs-toggle="modal" data-bs-target="#insertar-tipocurso-modal">
                                <i class="bx bx-plus me-1"></i>Agregar Tipo de Curso
                            </button>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                    <?php
                                    $nombreTabla = "tipocurso_table";
                                    $nombreCampos = ["ID", "Nombre", "Código", "Observaciones",  "Estado", "Acción"];
                    $nombreCamposFooter = [
                        "ID",
                        "Nombre",
                        "Código",
