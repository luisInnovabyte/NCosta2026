...
<head>
    ...
    <!-- SELECT -->
    <link rel="stylesheet" type="text/css" href="../../public/js/libs/select2/dist/css/select2.min.css">
    <!-- CSS DE DROPZONE IMG -->
    <link rel="stylesheet" type="text/css" href="../../public/js/libs/dropzone/dist/min/dropzone.min.css">

    <link rel="stylesheet" type="text/css" href="../../public/js/libs/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css">
</head>
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-10 col-md-10 col-lg-10">
                            <div class="card-body">
                                <h4 class="card-title">Actividad:
                                    <b class="<?= $datosActividad[0]['estadoAct'] == '1' ? 'tx-success' : 'tx-danger' ?>"><?= $datosActividad[0]['descrAct'] ?></b>
                                </h4>
                        ...
                        <div class="col-sm-2 col-md-2 col-lg-2 align-items-center d-lg-flex justify-content-lg-end">
                            <div class="text-center">
                                ...
                                <button type="button" class="btn btn-outline-primary mb-lg-0 mb-3" data-toggle="modal" data-target="#insertar-alumno-modal">
                                    Añadir Alumno
                                </button>
                    ...
                    <div class="table-responsive">
                        ...
                        $nombreCampos = ["ID", "Nombre", "Fecha Alta", "Dar de Baja", "Asistencia"];
                        $nombreCamposFooter = [
                            "ID", "Nombre", "Fecha Alta", "Dar de Baja", "Asistencia"
                        ];
            ...
            <!-- MODAL INSERTAR   -->
            <!-- ============================================================== -->
            <?php include_once 'modalInsertarAlumno.php' ?>
             <!-- ============================================================== -->
            <!-- MODAL AYUDA  -->
            <!-- ============================================================== -->
