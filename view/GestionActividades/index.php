            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        </div>    <input type="hidden" id="idUsuarioProfesorado" value="<?php echo $idUsuarioProfesorado ?>">
                    ...
                    <!-- ################################# -->
                                <div id="tablaAdmin"  class="table-responsive order-mobile-first">
                                    <a id="botonAddAlumno" id="" href="./gestionarActividad.php">
                                        <button type="button" class="btn btn-outline-primary mb-lg-0 mb-3" data-toggle="modal" data-target="#insertar-tipocurso-modal">
                                            Añadir actividad
                                        </button>
                                    </a>
                                    <?php
