...
<head>
    ...
    $datos = $personal->get_personal_x_id($_GET["idPersonal"]);
...
<body>
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="responsable-header d-flex justify-content-between align-items-center mg-b-10">
                            <h5 class="responsable-info">
                                <i class="fas fa-user-circle"></i>
                                <?php echo $datos[0]['idPersonal'].' - '.$datos[0]['nomPersonal'].' '.$datos[0]['apePersonal']; ?>
                            </h5>
                            <button class="btn btn-primary waves-effect" data-bs-toggle="modal" data-bs-target="#insertar-contrato-modal">
                        ...
                        <div class="col-12">
                            ...
                            <input type="hidden" id="idPersonal" value="<?php echo $_GET["idPersonal"] ?>">
                            <div class="row">

                                <div class="table-responsive order-mobile-first">
                                    <?php
                                    $nombreTabla = "contrato_table";
                                    $nombreCampos = ["ID", "Tipo Contrato", "Fecha","Categoría","Jornada","Duración", "Estado", "Descripción", "Acción"];
                                    $nombreCamposFooter = ["ID", "Tipo Contrato", "Fecha","Categoría","Jornada","Duración", "Estado", "Descripción", "Acción"];
                        ...
                        <a href="../MntPersonal_Edu" class="col-lg-2 col-12 mg-2 btn btn-secondary">Volver</a>
    ...
    <!-- Search Modal -->
    <?php include_once 'modalAgregarContrato.php' ?>
    <?php include_once 'modalEditarContrato.php' ?>
...
<?php include("../../config/templates/mainFooter.php"); ?>
    ...
    <script src="contratoIndex.js"></script>
    <!--end plugins extra-->
