            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <button class="btn btn-primary waves-effect col-12 col-lg-1" data-bs-toggle="modal" data-bs-target="#insertar-personal-modal">Agregar Personal</button>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                    ...
                                    $nombreCampos = ["ID", "Nombre", "Dirección", "Teléfono", "Email", "Rol", "Estado", "Acción", "Contratos", "Documentos"];
                            ...
                            "Rol", "Estado", "Acción", "Contratos", "Documentos"];
