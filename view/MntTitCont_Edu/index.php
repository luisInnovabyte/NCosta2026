    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Titulares de los Contenidos</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    <h2 class="card-title">Titulares de los Contenidos</h2>
                        ...
                        <div class="row">
                            <div class="col-4">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-12 mg-sm-b-10">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="titCont" name="titCont" class="form-control" placeholder="Escriba un titular" style="flex: 0 0 70%;">
                                                <button onclick="agregarTitContenido()" id="newConceptos" class="btn btn-primary" style="flex: 0 0 30%;">Añadir</button>
                                            </div>
                                ...
                                <div class="d-none bd-3 pd-t-80 pd-b-80" id="updateRow">
                                    ...
                                    <div class="row">
                                        <div class="input-group col-lg-12 tx-center mg-b-10">
                                            <div class="input-group" id="inputEditar">
                                                <input type="text" class="form-control" id="text-editar" placeholder="Escriba un titular" style="flex: 0 0 70%;">

                                                <input type="hidden" id="idTit">

                                                <button onclick="insertarEditar()" class="btn btn-success" style="flex: 0 0 10%;">Editar</button>

                                                <button onclick="ocultarEditar()" class="btn btn-danger" style="flex: 0 0 10%;">Cancelar</button>
                                            </div>
