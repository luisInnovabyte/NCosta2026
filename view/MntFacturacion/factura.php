...
<body>
            ...
            <div class="row">
                <div class="table-responsive order-mobile-first">
                    <?php
                        ...
                        $nombreCampos = ["id","Código", "Concepto", "Tipo", "IVA (%)", "Descuento (%)", "Subtotal (€)", "Total (€)"];
                        $nombreCamposFooter = ["id","Código", "Concepto", "Tipo", "IVA", "Descuento", "Subtotal", "Total"];
                        $cantidadGrupos = 1;
                        $columGrupos = [];
    ...
    <script src="facturaAbono.js"></script>
</body>
