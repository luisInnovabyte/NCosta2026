    ...
    <main class="page-content">
        ...
        <div class="row">
            ...
            <div class="page-header-custom">
                <h2><i class='bx bx-receipt me-2'></i>Gestión de IVA</h2>
                <p>Administra los tipos de IVA aplicables a tarifas y servicios</p>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end mb-3">
                            <button class="btn btn-add-record waves-effect" data-bs-toggle="modal" data-bs-target="#agregar-iva-modal">
                                <i class="bx bx-plus me-1"></i>Agregar IVA
                            </button>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                    <?php
                                    $nombreTabla = "iva_table";
                                    $nombreCampos = ["ID", "Valor", "Descripcion", "Estado", "Acciones"];
                                    $nombreCamposFooter = ["ID", "Valor", "Descripcion", "Estado", "Acciones"];
