            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 row d-flex justify-content-end pd-0-force mg-0-force mg-b-10-force">
                            <button class="btn btn-primary waves-effect col-12 col-lg-1" data-bs-toggle="modal" data-bs-target="#agregar-iva-modal">Agregar IVA</button>
                        </div>
                        <div class="col-12">
