...
var idDatatables = "pagos_table"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
var phpPrincipal = "pagos_Edu.php"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
...
columnDefs: [
    ...
    //valor
    { targets: [2], orderData: [1], visible: true, width: "8%" },
    //accion
    { targets: [3], orderData: false, visible: true, className: 'secundariaDef' }
],
 ...
 "ajax": {
        ...
        url: "../../controller/"+phpPrincipal+"?op=listarPagos",
        type: "get",
        dataType: "json",
        cache: false,
        serverSide: true,
...
function agregarElemento() {
  ...
  var formData = new FormData($("#insertar-pago-form")[0]);
  ...
  if (!validacion) {
    ...
    $.ajax({
      url: "../../controller/pagos_Edu.php?op=insertarPago",
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
      success: function () {
          ...
          $("#insertar-pago-form")[0].reset();

          $('#insertar-pago-modal').modal('hide');
      }
  });
  } else {
