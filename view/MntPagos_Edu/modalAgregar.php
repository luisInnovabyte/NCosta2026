<div id="insertar-pago-modal" class="modal fade">
            ...
            <div class="modal-body">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4 ">Nuevo Medio de Pago</h5>
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-lg-12">
                                    ...
                                    <div class="position-relative input-icon">
                                        ...
                                        <input type="text" class="form-control" id="nomPagoInsert" name="nomPago" placeholder="Nombre" data-type="3" data-min="3" data-max="60" data-new-input="1" data-descripcion="1" data-required="1">
                                    </div>
                                </div>
