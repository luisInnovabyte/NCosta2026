    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Medios de Pago</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            ...
            <div class="page-header-custom">
                <h2><i class='bx bx-credit-card me-2'></i>Gestión de Medios de Pago</h2>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end mb-3">
                            <button class="btn btn-add-record waves-effect" data-bs-toggle="modal" data-bs-target="#insertar-pago-modal">
                                <i class="bx bx-plus me-1"></i>Agregar Medio de Pago
                            </button>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                    <?php
                                    $nombreTabla = "pagos_table";

                                    $nombreCampos = ["ID", "Nombre", "Estado", "Acción"];
                                    $nombreCamposFooter = [
                                        "ID",
                                        "<input type='text' class='form-control' id='Descripcion' name='Descripcion' placeholder='Buscar Nombre'>",
                                        "Estado",
