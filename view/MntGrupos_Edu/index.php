            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <button class="btn btn-primary waves-effect col-12 col-lg-1" data-bs-toggle="modal" data-bs-target="#insertar-grupo-modal">Agregar Grupo</button>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                    <?php
                                    $nombreTabla = "grupos_table";
                                    $nombreCampos = ["ID", "Nombre", "Dirección", "Teléfono", "Identificador","Estado", "Acción"];
                                    $nombreCamposFooter = [
                                        "ID", "Nombre", "Dirección", "Teléfono", "Identificador","Estado", "Acción"
                                    ];
