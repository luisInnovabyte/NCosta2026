<div id="buscar-agente-modal" class="modal fade">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Buscar Agente</h5>
            ...
            <div class="modal-body">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <div class="row">
                            <h5 class="mb-4 ">Buscar Agente</h5>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                    ...
                                    $nombreCampos = ["ID", "Nombre", "Identificacion", "Domicilio","Correo"];
                                    $nombreCamposFooter = ["ID", "Nombre", "Identificacion", "Domicilio","Correo"];
