<div id="seleccionar-prescriptor-modal" class="modal fade">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Seleccionar interesado</h5>
            ...
            <div class="modal-body">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Selecciona el interesado para mostrar / editar </h5>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="table-responsive order-mobile-first">
                                        ...
                                        $nombreCampos = ["ID", "Nombre", "E-mail", "Teléfono/Movil"];
                                        $nombreCamposFooter = ["ID", "Nombre", "E-mail", "Teléfono/Movil"];
