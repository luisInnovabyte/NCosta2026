    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item" aria-current="page">Test de Nivel</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    <h2 class="card-title">Mantenimiento Test de Nivel</h2>
                    ...
                    <div class="row">
                        ...
                        <button class="btn btn-primary waves-effect col-12 col-lg-1" data-bs-toggle="modal" data-bs-target="#insertar-tipocurso-modal">Agregar Test de Nivel</button>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                    <?php
                                    $nombreTabla = "testnivel_table";
                                    $nombreCampos = ["ID", "Nombre", "Tipo de Curso","Idioma", "Archivo",  "Estado", "Acción"];
                                    $nombreCamposFooter = [
                                        "ID",
                                        "<input type='text' class='form-control' id='FootDescripcion' name='FootDescripcion' placeholder='Buscar Nombre'>",
                                        "<input type='text' class='form-control' id='FootCodigo' name='Footcodigo' placeholder='Buscar Tipo Curso'>",
                                        "Idioma", 
                                        "Archivo", 
                                        "Estado",
                                        "Acción"
