...
var idDatatables = "testnivel_table"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
var phpPrincipal = "testNivel_Edu.php"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
var idModalAgregar = "insertar-testnivel-modal"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
var idModalEditar = "editar-testnivel-modal"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
...
var testNivel = $("#" + idDatatables + "").DataTable({
  ...
  columnDefs: [
    ...
    { targets: [2], orderData: [2], visible: true, autoWidth: true },
    { targets: [3], orderData: [3], visible: true, autoWidth: true },
    { targets: [4], orderData: false, visible: true, autoWidth: true },
    { targets: [5], orderData: [5], visible: true, autoWidth: true },
    {
      targets: [6],
      orderData: false,
      visible: true,
  ...
  ajax: {
    url: "../../controller/" + phpPrincipal + "?op=listarTestNivel",
    type: "get",
    dataType: "json",
    cache: false,
    serverSide: true,
...
function cargarElemento(idElemento) {
  ...
  $.post(
    ...
    function (data) {
      ...
      $("#id-tipocurso").val(idElemento);

      //Cargar datos
      $("#descripcion-Tipo").val(data[0].descrTipo);
      $("#codigo-Tipo").val(data[0].codTipo);
      $("#minAlum-Tipo").val(data[0].minAlumTipo);
      $("#maxAlum-Tipo").val(data[0].maxAlumTipo);
      $("#text-Tipo").val(data[0].textTipo);
      $("#text-Tipo").text(data[0].textTipo);
