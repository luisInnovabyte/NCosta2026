    ...
    <main class="page-content">
        ...
        <div class="row">
            ...
            <div class="page-header-custom">
                <h2><i class='bx bx-chalkboard me-2'></i>Gestión de Aulas</h2>
                <p>Administra las aulas, capacidades y características de los espacios</p>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end mb-3">
                            <button class="btn btn-add-record waves-effect" id="insertarAula">
                                <i class="bx bx-plus me-1"></i>Agregar Aula
                            </button>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive order-mobile-first">
                                         ...
                                         <?php
                                            ...
                                            $nombreCampos = ["ID", "Nombre", "Localizacion", "Capacidad","Características", "Observación", "Estado", "Acción"];
                                            $nombreCamposFooter = [
                                               "ID", "Nombre", "Localizacion", "Capacidad","Características", "Observación", "Estado", "Acción"
                                            ];
