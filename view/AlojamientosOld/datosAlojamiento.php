...
<head>
	...
	require_once("../../models/TiposAloja.php");
	...
	if (!isset($_SESSION['usu_rol'])) { // SI NO TIENE ROL
		...
		if (isset($_GET['idAloja']) && $_GET['idAloja'] != '') { // SI EXISTE LA VARIABLE, Y ES DISTINTO DE '' (VACIO)
			...
			$idAlojaEncrypt = $_GET['idAloja'];
			$idAloja = decryptNumber($_GET['idAloja']);
								...
								<div class="wizard-content-form">
									<div class="wizard-form-field">
										<div class="row">
											...
											<div class="col-12 col-md-6 wizard-form-input position-relative form-group has-float-label">
												<div class="wizard-form-input position-relative form-group has-float-label">
													<textarea id="hospitalPublicAloja" name="hospitalPublicAloja" class="form-control" rows="4" maxlength='75' placeholder="Dirección hospital público más cercano" value="<?php echo $datosAlojamiento[0]['hospitalPublicAloja'] ?>"></textarea>
													<label for="textDatosPublicAloja">Dirección hospital público más cercano</label>
												</div>
											</div>
											<div class="col-12 col-md-6 wizard-form-input position-relative form-group has-float-label">
												<div class="wizard-form-input position-relative form-group has-float-label">
													<textarea id="consultAloja" name="consultAloja" class="form-control" rows="4" maxlength='150' placeholder="Dirección centro médico más cercano" value="<?php echo $datosAlojamiento[0]['consultAloja'] ?>"></textarea>
													<label for="textDatosPublicAloja">Dirección centro médico más cercano</label>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-12 col-md-6 wizard-form-input position-relative form-group has-float-label">
												<div class="wizard-form-input position-relative form-group has-float-label">
													<textarea  id="hospitalPrivAloja" name="hospitalPrivAloja"  rows="4" maxlength='150'  class="form-control" placeholder="Dirección hospital privado más cercano" value="<?php echo $datosAlojamiento[0]['hospitalPrivAloja'] ?>"></textarea>
													<label for="textDatosPublicAloja">Dirección hospital privado más cercano</label>
												</div>
											</div>
											<div class="col-12 col-md-6 wizard-form-input position-relative form-group has-float-label">
												<div class="wizard-form-input position-relative form-group has-float-label">
													<textarea type="text" id="pagoAloja" rows="4" maxlength='150'  name="pagoAloja" class="form-control" placeholder="Cuenta bancaria de la familia"  value="<?php echo $datosAlojamiento[0]['pagoAloja'] ?>"></textarea>
										...
										<div class="row">
											<div class="col-12 col-md-6">
												<div class="n-summary">
													...
													<label>
														<input type="radio" value="1" name="interAloja" <?php if ($datosAlojamiento[0]['interAloja'] == 1) echo 'checked'; ?>>
														<span class="checkmark">Si</span>
													</label>
													<label>
														<input type="radio" value="0" name="interAloja" <?php if ($datosAlojamiento[0]['interAloja'] == 0) echo 'checked'; ?>>
