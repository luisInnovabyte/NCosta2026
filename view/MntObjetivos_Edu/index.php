...
@keyframes fadeOutAnimation {
  ...
  100% {
    ...
    <?php 
        ...
        $datosObjetivo = $objetivos->listarObjetivo($idTitular);
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Objetivos</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    ...
                    <input type="hidden" id="titObjetivoId" value="<?php echo $_GET['id']?>">
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row" id="addCont">
                        <div class="col-12 d-flex justify-content-between align-items-center mg-b-10">
                            <p class='badge bg-info tx-20-force m-0'><?php echo $datosObjetivo[0]['descrTitObjetivo'];?></p>
                            <button class="btn btn-primary waves-effect col-12 col-lg-2" data-bs-toggle="modal" data-bs-target="#insertar-objetivos-modal">
                                Agregar Sección
                            </button>
                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="table-responsive order-mobile-first">
                                        <?php
                                        $nombreTabla = "objetivos_table";
                                        $nombreCampos = ["IdObjetivo","Titular","Objetivo","Estado","Acciones"];
                                        $nombreCamposFooter =  ["IdObjetivo","Titular","Objetivo","Estado","Acciones"];
