    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                        ...
                        <form id="insertar" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="position-relative input-icon">
                                        <span class="position-absolute top-50 translate-middle-y"><i class="bi bi-caret-right"></i></span>
                                        <input type="number" class="form-control" id="minAlumTipo" name="minAlumTipo" placeholder="Nombre" value="1" data-type="3" data-min="1" data-max="2" data-new-input="1" data-descripcion="1" data-required="1">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="position-relative input-icon">
                                        <span class="position-absolute top-50 translate-middle-y"><i class="bi bi-caret-right"></i></span>
                                        <input type="number" class="form-control" id="maxAlumTipo" name="maxAlumTipo" placeholder="Nombre" value="2" data-type="3" data-min="1" data-max="2" data-new-input="1" data-descripcion="1" data-required="1">
                                    </div>
                                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" title="Guardar Cambios" onClick="agregarElementoCursoDeseado()">Aceptar</button>
            </div>
        </div>
    </div>
</div>