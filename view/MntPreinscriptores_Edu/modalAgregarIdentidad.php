<div id="agregar-identidad-modal" class="modal fade" data-bs-backdrop="static">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary bg-gradient text-white py-3">
                <h5 class="modal-title d-flex align-items-center gap-2">
                    <i class="bi bi-plus-circle"></i> Nuevo Documento Identificativo
                </h5>
                ...
                <form id="insertarIdentidad" method="POST">
                    ...
                    <div class="row g-4">
                        <div class="col-12 col-lg-6">
                            <label for="nombreIdentidad" class="form-label fw-semibold text-secondary">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0 ps-0" id="nombreIdentidad" name="nombreIdentidad" placeholder="Nombre del tipo de documento" data-type="3" data-min="3" data-max="20" data-new-input="1" data-descripcion="1" data-required="1">
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer bg-light border-top-0 py-3">
                ...
                <button type="button" class="btn btn-primary px-4" title="Guardar" onClick="guardarElementoIdentidad()">
