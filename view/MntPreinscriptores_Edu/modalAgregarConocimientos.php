        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary bg-gradient text-white py-3">
                <h5 class="modal-title d-flex align-items-center gap-2">
                    <i class="bi bi-plus-circle"></i> Nuevo Conocimiento
                </h5>
                    ...
                    <div class="row g-4">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0 ps-0" id="nombreConocimiento" name="nombreConocimiento" placeholder="Nombre del conocimiento" data-type="3" data-min="3" data-max="20" data-new-input="1" data-descripcion="1" data-required="1">
                            </div>
                        </div>
