<div id="agregar-conocimiento-modal" class="modal fade">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-lg-12">
                                ...
                                <div class="position-relative input-icon">
                                    ...
                                    <input type="text" class="form-control" id="nombreTipo" placeholder="WWW" data-type="3" data-min="3" data-max="20" data-new-input="1" data-descripcion="1" data-required="1">
                                </div>
                            </div>
