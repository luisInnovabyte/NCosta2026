...
<head>
    ...
    //checkAccess(['0', '1', '2', '3']);
    checkAccess(['3']);
    // SI EXISTE EL COLOR DEPARTAMENTO GUARDADO EN SESIÓN, SE GUARDA EN LA VARIABLE COLOR DEPARTAMENTO, SINO, SE PONE EL COLOR NORMAL AZUL
    ...
    <script>
        ...
        console.log(getComputedStyle(document.documentElement).getPropertyValue('--color-principal'));
    </script>
    -->
        ...
        <div class="row">
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    ...
                    <div class="container-fluid viewcalendar d-none">
                    <div style="margin: 10px 0; font-size: 15px;">
                        <strong>Legend:</strong>
                        <div style="display: flex; gap: 20px; margin-top: 5px;">
                            <div style="display: flex; align-items: center; gap: 6px;">
                            <div style="width: 15px; height: 15px; background-color: #007bff; border-radius: 3px;"></div>
                            <span>No Homework</span>
                            </div>
                            <div style="display: flex; align-items: center; gap: 6px;">
                            <div style="width: 15px; height: 15px; background-color: #28a745; border-radius: 3px;"></div>
                    ...
                    <div class="text-center mt-3">
                        <button type="button" onclick="mostrarCursos()" class="btn btn-danger">
                        Mostrar cursos / View Courses
                        </button>
                    </div>
                    </div>
