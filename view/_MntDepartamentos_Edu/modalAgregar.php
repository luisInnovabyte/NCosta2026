<div id="insertar-departamento-modal" class="modal fade">
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-lg-12">
                                    ...
                                    <div class="position-relative input-icon">
                                        ...
                                        <input type="text" class="form-control" id="nomDepartamento" name="nomDepartamento" placeholder="Nombre" data-type="3" data-min="1" data-max="50" data-new-input="1" data-descripcion="1" data-required="1">
                                    </div>
                                </div>
                            </div>
                        </form>
