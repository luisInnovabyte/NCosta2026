...
var idDatatables = "departamentos_table"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
var phpPrincipal = "departamentos_Edu.php"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
var idModalAgregar = "insertar-departamento-modal"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
var idModalEditar = "editar-departamento-modal"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
...
var departamentos_table = $("#" + idDatatables + "").DataTable({
  ...
  columns: [
    ...
    { name: "estDepartamento", className: "text-center" },
  ...
  ajax: {
    url: "../../controller/" + phpPrincipal + "?op=listarDepartamentos",
    type: "get",
    dataType: "json",
    cache: false,
    serverSide: true,
...
function agregarElemento() {
  ...
  let nomDepartamento = $("#nomDepartamento").val();
  ...
  if (!validacion) {
    ...
    $.post("../../controller/departamentos_Edu.php?op=insertarDepartamento",{nomDepartamento:nomDepartamento},function (data) {
...
function cargarElemento(idElemento) {
  ...
  $.post("../../controller/departamentos_Edu.php?op=cargarElemento",{idElemento:idElemento},function (data) {
    data = JSON.parse(data);
    $("#nomDepartamentoE").val(data[0]["nombreDepartamento"]);
    $("#id-departamento").val(data[0]["idDepartamento"]);
...
function editarElemento() {
  ...
  let idDepartamentos = $("#id-departamento").val();
  let nomDepartamentoE = $("#nomDepartamentoE").val();
  //TODO: RECOGER TANTOS CAMPOS COMO SEA NECESARIOS
  ...
  if (!validacion) {
    ...
    $.post("../../controller/departamentos_Edu.php?op=editarDepartamento",{idDepartamentos:idDepartamentos,nomDepartamentoE:nomDepartamentoE},function (data) {
