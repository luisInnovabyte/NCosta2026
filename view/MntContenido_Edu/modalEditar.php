<div id="modal-titulares" class="modal fade">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Seleccionar Titular</h5>
            ...
            <div class="modal-body">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4 ">Seleccionar Titular</h5>

                        <div class="row">
                            <div class="table-responsive order-mobile-first">
                                <?php
                                $nombreTabla = "contenido_table_titular";
                                ...
                                $colorHEX = "#3ef00A"; //* COLOR POR DEFECTO DE LAS AGRUPACIONES *// //= Color Hexadecimal #000000 ~ #FFFFFF ==//
