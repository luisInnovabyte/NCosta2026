        ...
        <div class="row">
           <div class="col-12 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mx-auto">
            <div class="card border-3">
              ...
              <img src="../../public/img/logo-icon.png" class="mb-4" width="200" alt="">
                  ...
                  <div class="form-body mt-4">
										<form class="row g-3">
											<div class="col-12">
												...
												<input type="text" class="form-control" id="NewPassword" placeholder="Introduce nueva contraseña">
											</div>
                      <div class="col-12">
                        <label class="form-label" for="ConfirmPassword">Confirmar Contraseña</label>
                        <input type="text" class="form-control" id="ConfirmPassword" placeholder="Confirma la nueva contraseña">
                      </div>
											<div class="col-12">
