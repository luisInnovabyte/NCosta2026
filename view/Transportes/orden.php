...
<head>
    ...
    $datos = $comercial->recogerJson();
    $header = $datos[0]["mainHeader_Json"];
    ...
    ** Darkmode 05/02
    ...
    $jsonDatos2 = json_decode($datosOrden['jsonOrdenTransporte'], true);
                    ...
                    <div class="form-layout form-layout-2 tx-danger">
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        <h6 class="tx-12">Ejemplar oara el remitente- Exemplaire de l'expéditeur<br>Copy for sender</h6>
                                    </div>
                                    ...
                                    <table class="tableCMR" style="border-collapse: collapse;">
                                        <tr class="bd">
                                            ...
                                            <td class="bd">
                                                <table>
                                                    <tr>
                                                        <td><label class="tx-bold tx-10">CARTA DE PORTE INTERNACIONAL<br>LETTRE DE VOITURE INTERNATIONALE<br>INTERNATIONAL CONSIGNMENT NOTE</label></td>
                                                        <td><label class="tx-9">Este Transporte queda sometido, no obstante<br>toda cláusula contraria, al Convenio sobre el<br>Contrato de Transporte Internacional de<br>Mercancías por Carretera (CMR).</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" class="tx-center"><label class="tx-20 tx-bold">CMR</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="tx-9">Ce Transport est soumis, nonobstant toute<br>clause contraire, à la Convention relative au<br>contrat de transport international de<br>marchandises par route (CMR).</label></td>
                                                        <td><label class="tx-9">This carriage is subject, notwithstanding any<br>clause to the contrary, to the Convention<br>on the Contract for the international Carriage<br>of good by road (CMR).</label></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="bd" rowspan="10">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="tx-9">Peso brutok, Kg.<br>Poids brut, Kg.<br>Gross weight in Kg.</h6>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <div class="col-6 borde-gris-derecho row">
                                                ...
                                                <div class="col-12 row">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <input class="form-control" type="text" readonly name="tipo" title="*** <?php echo $jsonDatos['TIPO_CONT']; ?>" value="*** <?php echo $jsonDatos['TIPO_CONT']; ?>">
                                                    </div>
                                                    <div class="col-4">
                                            ...
                                            <div class="col-6 ">
                                                ...
                                                <div class="row mg-5">
                                                    ...
                                                    <div class="col-4  form-inline">
                                                        ...
                                                        <input class=" form-control wd-30-force" type="text" readonly name="" value="No">
                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="tx-bold">
                                                                <div class="form-inline">
                                                                    ...
                                                                    <input class="form-control" type="text" readonly name="tipoOrden" readonly value="********">
                                                                </div>
                                                            </th>
                                                        </tr>
                                                    </tbody>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4  form-inline ">
                                                ...
                                                <input class=" form-control" type="text" readonly name="refCarga" value="">
                                ...
                                <header>
                                    ...
                                    <div class="row mt-4 text-left tx-14" style="line-height: 8px">
                                        <div class="col-6">
                                            ...
                                            <p>Precio acordado: <span style="font-weight: normal">1.491,94 €</span></p>
                                        </div>
                                        <div class="col-6">
