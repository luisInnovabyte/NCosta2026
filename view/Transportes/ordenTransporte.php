...
<body>
                                    ...
                                    <div class="col-12  row  mg-b-20">
                                        ...
                                        <div class="col-12 row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <label id="tipo" class="form-control-personalizado tx-break text-reset">*** ** <?php echo $jsonDatos['TIPO_CONT']; ?></label>
                                ...
                                <div class="row  d-flex justify-content-center">
                                    ...
                                    <div class="col-12  row  mg-b-20  d-flex justify-content-center">
                                        ...
                                        <div class="col-4 ">
                                            ...
                                            <label id="conectar" class="form-control-personalizado tx-break text-reset"> ****</label>
                                ...
                                <div class="row  d-flex justify-content-center">
                                    ...
                                    <div class="col-12  row ">
                                        ...
                                        <div class="col-6 mg-b-5">
                                            ...
                                            <label id="tipoOrden" class="form-control-personalizado tx-break text-reset">*******</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <aside class="customizer botonFlotante5">
        <a href="javascript:void(0)" class="service-panel-toggle colorBoton5 tx-20">
