...
var idDatatables = "medidaAloja_table"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
var phpPrincipal = "medidasAloja_Edu.php"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
var idModalAgregar = "insertar-medidaAloja-modal"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
var idModalEditar = "editar-medidaAloja-modal"; //TODO: CAMBIAR EL STRING SEGUN EL MANTENIMIENTO
...
var medidaAloja_table = $("#" + idDatatables + "").DataTable({
  ...
  columns: [
    ...
    { name: "idMedidaAloja" },
    { name: "descrMedidaAloja" , type: 'string'},
    { name: "textMedidaAloja", type: 'string' },
    { name: "estMedidaAloja", "className": "text-center" },
...
columnDefs: [
  ...
  "ajax": {
    ...
    url: "../../controller/"+phpPrincipal+"?op=listarMedidasAloja",
    type: "get",
    dataType: "json",
    cache: false,
    serverSide: true,
...
function agregarElemento() {
  ...
  //TODO: RECOGER TANTOS CAMPOS COMO SEA NECESARIOS
    var formData = new FormData($("#insertar-medidaAloja-form")[0]);
  ...
  if (!validacion) {
    ...
    $.ajax({
        url: "../../controller/medidasAloja_Edu.php?op=insertarMedidaAloja",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
        ...
        $("#"+idModalAgregar+"").modal("hide");
        toastr.success("Medida agregada");
...
function cargarElemento(idElemento) {
  ...
  $.ajax({
    url: "../../controller/medidasAloja_Edu.php?op=recogerEditar",
    type: "POST",
    data: { 'idMedidaAloja': idElemento },
    dataType: "json",

    success: function (response) {
        $("#id-medidaAloja").val(response[0])
        $("#descripcion-medidaAloja").val(response[1])
        $("#observaciones-medidaAloja").text(response[2]);
        $("#observaciones-medidaAloja").val(response[2]);
...
function editarElemento() {
  ...
  if (!validacion) {
    ...
    var formData = new FormData($("#editar-medidaAloja-form")[0]);

    $.ajax({
        url: "../../controller/medidasAloja_Edu.php?op=editarMedidaAloja",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
        ...
        success: function () {
          ...
          toastr.success("La Medida de Alojamiento se ha editado");
