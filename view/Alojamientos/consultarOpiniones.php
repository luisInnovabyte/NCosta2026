...
<body>
    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item" aria-current="page">Consultar Opiniones<i class="lni emoji-speechless display-7 text-muted" title=""></i></li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            ...
            <input type="hidden"id="idVisAloja" value="<?php echo $datos[0]['idAloja'] ?>">
                <div class="card-body">
                ...
                <div class="table-responsive">
                    <?php
                        ...
                        $nombreCamposFooter = ["ID", "Nombre","Correo","Telefono", "Valoración", "Comentario", "Fecha", "Acción"];
