    ...
    <main class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    <h2 class="card-title">Niveles</h2>
                    ...
                    <div class="row">
                        ...
                        <button class="btn btn-primary waves-effect col-12 col-lg-2" data-bs-toggle="modal" data-bs-target="#insertar-nivel-modal">Agregar Nivel</button>
                        </div>
                        <div class="col-12">
