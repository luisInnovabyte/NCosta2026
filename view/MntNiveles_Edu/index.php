    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Niveles</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            ...
            <div class="page-header-custom">
                <h2><i class='bx bx-layer me-2'></i>Gestión de Niveles</h2>
                <p>Administra los niveles educativos y su configuración</p>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end mb-3">
                            <button class="btn btn-add-record waves-effect" data-bs-toggle="modal" data-bs-target="#insertar-nivel-modal">
                                <i class="bx bx-plus me-1"></i>Agregar Nivel
                            </button>
                        </div>
                        <div class="col-12">
