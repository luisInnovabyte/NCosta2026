                        ...
                        <input type="hidden" id="id-nivel" name="idNivel">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-lg-12">
                                    ...
                                    <div class="position-relative input-icon">
                                        <span class="position-absolute top-50 translate-middle-y"><i class="bi bi-caret-right"></i></span>
                                        <input type="text" class="form-control" id="codigo-nivel" name="codNivel" placeholder="Nombre" data-type="3" data-min="1" data-max="6" data-new-input="1" data-descripcion="1" data-required="1">
                                    </div>
                                </div>
